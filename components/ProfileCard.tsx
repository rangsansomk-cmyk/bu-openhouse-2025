...
const ProfileCard: React.FC = () => {
    ...
    const socialLinks = [
        {
            name: 'Email',
            href: 'mailto:Srangsan.somk@bumail.net',
            icon: (
        ...
        {
            name: 'Instagram',
            href: 'https://instagram.com/me.rs_23',
            icon: (
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
        ...
        {
            name: 'Facebook',
            href: 'https://facebook.com/rangsrrkh.sm.kha.ney',
            icon: (
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div className="mb-4">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-center justify-center">
                            <div className="flex items-center space-x-2">
                                ...
                                <div>
                                    <p className="text-white font-medium text-sm sm:text-base">rangsan.somk@bumail.net</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                <div>
                                    <p className="text-white font-medium text-sm sm:text-base">095 - 819 - 9161</p>
                                </div>
                            </div>
                        </div>
                    </div>
